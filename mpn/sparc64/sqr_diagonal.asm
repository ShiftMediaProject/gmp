...
C which case performance problems in particular for 2 and 3 limbs.  Ultimately,
C this should be replaced by hand-written code in the same software pipeline
C style as e.g., addmul_1.asm.
