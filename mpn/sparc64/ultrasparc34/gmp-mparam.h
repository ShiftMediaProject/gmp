...
#define MUL_FFT_TABLE3                                      \
  { {    248, 5}, {     13, 6}, {     17, 7}, {      9, 6}, \
    ...
    {    383,10}, {    103, 9}, {    207, 8}, {    415,12}, \
    {     31,11}, {     63,10}, {    127, 9}, {    255,10}, \
    {    143, 9}, {    287, 8}, {    575,11}, {     79,10}, \
    {    159, 9}, {    319, 8}, {    639, 9}, {    351,11}, \
    {     95, 9}, {    383,10}, {    207, 9}, {    415,10}, \
    ...
    {     63,12}, {    127,11}, {    287,10}, {    575,12}, \
    {    159,11}, {    351,10}, {    703, 9}, {   1407,12}, \
    {    191,11}, {    415,12}, {    223,11}, {    447,13}, \
    {    127,12}, {    287,11}, {    575,12}, {    351,11}, \
    {    703,13}, {    191,12}, {    447,14}, {    127,13}, \
    {    255,12}, {    575,13}, {    319,12}, {    703,13}, \
    {    383,12}, {    831,13}, {    447,12}, {    895,14}, \
    {    255,13}, {    511,12}, {   1023,13}, {    575,12}, \
    {   1151,13}, {    639,12}, {   1279,13}, {    703,12}, \
    {   1407,14}, {    383,13}, {    895,15}, {    255,14}, \
    {    511,13}, {   1151,14}, {    639,13}, {   1407,14}, \
    {    767,13}, {   1663,14}, {    895,13}, {   1791,15}, \
    {    511,14}, {   1023,13}, {   2047,14}, {   1151,13}, \
    {   2303,14}, {   1407,15}, {  32768,16}, {  65536,17}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    244, 5}, {      8, 4}, {     17, 5}, {     15, 6}, \
    ...
    {   2175,13}, {   1215,14}, {    639,13}, {   1407,14}, \
    {    767,13}, {   1663,14}, {    895,13}, {   1791,15}, \
    {    511,14}, {   1023,13}, {   2047,14}, {   1151,13}, \
    {   2303,14}, {   1407,15}, {  32768,16}, {  65536,17}, \
    { 131072,18}, { 262144,19}, { 524288,20}, {1048576,21}, \
