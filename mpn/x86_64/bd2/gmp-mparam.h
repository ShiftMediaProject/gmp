...
#define MUL_FFT_TABLE3                                      \
  { {    376, 5}, {     19, 6}, {     10, 5}, {     21, 6}, \
    ...
    {    335,10}, {    671,11}, {    351,12}, {    191,11}, \
    {    383,10}, {    767,12}, {    223,11}, {    447,13}, \
    {    127,12}, {    255,11}, {    511,10}, {   1023,12}, \
    {    287,11}, {    575,12}, {    319,11}, {    639,10}, \
    ...
    {   1215,12}, {   2431,11}, {   4863,14}, {  16384,15}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    340, 5}, {     11, 4}, {     23, 5}, {     21, 6}, \
    ...
    {     79,10}, {    159,11}, {     95,10}, {    191, 6}, \
    {   3199, 7}, {   1727, 8}, {    895,10}, {    239,11}, \
    {    127,10}, {    255, 9}, {    511,10}, {    271,11}, \
    {    143,10}, {    287, 9}, {    575,10}, {    303, 8}, \
    {   1215,10}, {    319,12}, {     95,11}, {    191,10}, \
    ...
    {    319,10}, {   1279,11}, {    671,12}, {    351,13}, \
    {    191,12}, {    383,11}, {    767,12}, {    415,11}, \
    {    831,10}, {   1663,12}, {    447,11}, {    895,14}, \
    {    127,13}, {    255,12}, {    511,11}, {   1023,12}, \
    {    543,11}, {   1087,10}, {   2175,12}, {    607,13}, \
    {    319,11}, {   1279,12}, {    671,11}, {   1343,12}, \
    ...
    {   2431,11}, {   4863,13}, {   8192,14}, {  16384,15}, \
    {  32768,16}, {  65536,17}, { 131072,18}, { 262144,19}, \
    { 524288,20}, {1048576,21}, {2097152,22}, {4194304,23}, \
    {8388608,24} }
#define SQR_FFT_TABLE3_SIZE 169
