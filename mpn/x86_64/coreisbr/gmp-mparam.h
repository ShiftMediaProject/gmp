...
#define MUL_FFT_TABLE3                                      \
  { {    380, 5}, {     19, 6}, {     10, 5}, {     21, 6}, \
    ...
    {    319, 9}, {    639,10}, {    335,12}, {     95,11}, \
    {    191, 9}, {    767,11}, {    207,13}, {     63,12}, \
    {    127,10}, {    511,11}, {    271,10}, {    543,11}, \
    {    287,10}, {    575,12}, {    159,10}, {    639,11}, \
    {    335,10}, {    671,11}, {    351,10}, {    703,11}, \
    {    367,12}, {    191,11}, {    383,10}, {    767, 9}, \
    {   1535,10}, {    799,11}, {    415,10}, {    831,12}, \
    ...
    {    127,12}, {    511,11}, {   1023,12}, {    575,11}, \
    {   1151,12}, {    607,13}, {    319,12}, {    735,13}, \
    {    383,12}, {    767,11}, {   1535,12}, {    831,11}, \
    {   1663,13}, {    447,12}, {    959,11}, {   1919,14}, \
    {    255,13}, {    511,12}, {   1087,13}, {    575,12}, \
    {   1215,11}, {   2431,13}, {    639,12}, {   1279,13}, \
    {    703,12}, {   1407,14}, {    383,13}, {    767,12}, \
    {   1535,13}, {    831,12}, {   1663,13}, {    959,12}, \
    {   1919,14}, {    511,13}, {   1087,12}, {   2175,13}, \
    {   1215,12}, {   2431,14}, {  16384,15}, {  32768,16}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    340, 5}, {     19, 6}, {     10, 5}, {     21, 6}, \
    ...
    {     83,10}, {     55,11}, {     31,10}, {     79,11}, \
    {     47,10}, {     95,12}, {     31,11}, {     63,10}, \
    {    127, 9}, {    255, 8}, {    511,10}, {    135,11}, \
    {     79, 9}, {    319, 8}, {    639,11}, {     95,10}, \
    {    191, 9}, {    383,10}, {    207,12}, {     63,11}, \
    {    127,10}, {    255, 9}, {    511,10}, {    271, 7}, \
    {   2175,11}, {    143,10}, {    303, 7}, {   2431, 6}, \
    {   4863, 8}, {   1279, 7}, {   2559,10}, {    335,12}, \
    {     95,11}, {    191,10}, {    383,11}, {    207,13}, \
    {     63,12}, {    127,11}, {    271,10}, {    543, 9}, \
    {   1087,10}, {    575,11}, {    303,10}, {    607,11}, \
    {    335,10}, {    671, 9}, {   1343,11}, {    351,10}, \
    {    703,11}, {    383,10}, {    831,11}, {    447,10}, \
