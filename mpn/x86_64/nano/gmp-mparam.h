...
#define MUL_FFT_TABLE3                                      \
  { {    376, 5}, {     19, 6}, {     10, 5}, {     21, 6}, \
    ...
    {     63,10}, {    143,11}, {     79,10}, {    159, 9}, \
    {    319,10}, {    167,11}, {     95,10}, {    191, 9}, \
    {    383, 8}, {    767,11}, {    111,12}, {     63,11}, \
    {    127,10}, {    255, 9}, {    511,11}, {    143, 9}, \
    {    575, 8}, {   1151, 9}, {    607,11}, {    159,10}, \
    {    319, 9}, {    639, 8}, {   1279, 9}, {    671,11}, \
    ...
    {    671,11}, {    351,10}, {    703, 9}, {   1407,12}, \
    {    191,11}, {    383,10}, {    767, 9}, {   1535,11}, \
    ...
    {   1279,11}, {   2559,12}, {   1343,13}, {    703,12}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    340, 5}, {     19, 6}, {     10, 5}, {     21, 6}, \
    ...
    {    191,10}, {    111,12}, {     31,11}, {     63,10}, \
    {    127, 9}, {    271, 8}, {    543, 9}, {    287,11}, \
    {     79, 8}, {    639, 7}, {   1279, 9}, {    335, 8}, \
    {    671,10}, {    175,11}, {     95,10}, {    191, 9}, \
    {    383, 8}, {    767,10}, {    207, 9}, {    415,11}, \
    {    111,12}, {     63,11}, {    127,10}, {    255, 9}, \
    {    511, 8}, {   1023,10}, {    271, 9}, {    543,11}, \
    {    143, 9}, {    575, 8}, {   1151,10}, {    303, 9}, \
    {    607, 8}, {   1215,11}, {    159, 9}, {    639, 8}, \
    {   1279,12}, {     95,11}, {    191,10}, {    383, 9}, \
    {    767,10}, {    415, 9}, {    831, 8}, {   1663,11}, \
    {    223,13}, {     63,12}, {    127,11}, {    255,10}, \
    {    511, 9}, {   1023,11}, {    271, 9}, {   1087,11}, \
    {    287,10}, {    575, 9}, {   1215,11}, {    319,10}, \
    {    639, 9}, {   1279,10}, {    671, 9}, {   1343,10}, \
    {    703, 9}, {   1407,12}, {    191,11}, {    383,10}, \
    {    767, 9}, {   1599,11}, {    415,10}, {    831, 9}, \
    {   1663,11}, {    447,10}, {    959,13}, {    127,12}, \
    {    255,11}, {    511,10}, {   1023,11}, {    543,10}, \
    {   1087,11}, {    575,10}, {   1151,11}, {    607,10}, \
    {   1215,12}, {    319,11}, {    639,10}, {   1279,11}, \
    {    671,10}, {   1343,12}, {    351,11}, {    703,10}, \
    {   1407,12}, {    383,11}, {    767,10}, {   1535,12}, \
    {    415,11}, {    831,10}, {   1663,12}, {    447,11}, \
    {    895,10}, {   1791,12}, {    479,14}, {    127,13}, \
    ...
    {   1663,13}, {    447,12}, {    895,11}, {   1791,12}, \
    {    959,13}, {    511,12}, {   1023,11}, {   2047,12}, \
    {   1087,13}, {    575,12}, {   1215,13}, {    639,12}, \
    {   1343,13}, {    703,12}, {   1407,11}, {   2815,13}, \
