...
#define MUL_FFT_TABLE3                                      \
  { {    570, 5}, {     25, 6}, {     27, 7}, {     14, 6}, \
    ...
    {    143,10}, {    287, 9}, {    575,11}, {    159, 9}, \
    {    639,12}, {     95,11}, {    191,10}, {    383, 9}, \
    {    767,13}, {     63,12}, {    127,10}, {    543,11}, \
    {    287,12}, {    159,11}, {    335,10}, {    671,11}, \
    {    351,10}, {    703,11}, {    367,12}, {    191,11}, \
    {    383,10}, {    767,11}, {    415,12}, {    223,13}, \
    {    127,11}, {    511,10}, {   1023,11}, {    543,12}, \
    {    287,11}, {    575,10}, {   1151,11}, {    671,12}, \
    {    351,11}, {    703,13}, {    191,12}, {    383,11}, \
    {    767,12}, {    415,11}, {    831,12}, {    447,14}, \
    {    127,12}, {    543,11}, {   1087,12}, {    575,11}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    448, 5}, {     21, 6}, {     11, 5}, {     23, 6}, \
    ...
    {     79,10}, {    159,11}, {     95,10}, {    191,11}, \
    {    111,12}, {     63,11}, {    127,10}, {    255, 8}, \
    {   1023,11}, {    143,10}, {    287, 9}, {    575, 8}, \
    {   1151,11}, {    175,12}, {     95,11}, {    191, 9}, \
    {    767,11}, {    207,13}, {     63,12}, {    127,10}, \
    {    511,11}, {    271,10}, {    543,11}, {    303,10}, \
    {    607,12}, {    159,11}, {    319,10}, {    639,11}, \
    {    351, 9}, {   1407,11}, {    367,12}, {    191,11}, \
