...
#define MUL_FFT_TABLE3                                      \
  { {    570, 5}, {     25, 6}, {     13, 5}, {     27, 6}, \
    ...
    {    135,11}, {     79,10}, {    167,11}, {     95, 9}, \
    {    383,10}, {    199,12}, {     63,11}, {    159,12}, \
    {     95,11}, {    207,13}, {     63,12}, {    127,11}, \
    {    255,10}, {    543, 9}, {   1087,12}, {    159,11}, \
    ...
    {    511,15}, {   1023,14}, {   2303,15}, {  32768,16}, \
    {  65536,17}, { 131072,18}, { 262144,19}, { 524288,20}, \
    {1048576,21}, {2097152,22}, {4194304,23}, {8388608,24} }
#define MUL_FFT_TABLE3_SIZE 152
...
#define SQR_FFT_TABLE3                                      \
  { {    448, 5}, {     21, 6}, {     11, 5}, {     23, 6}, \
    ...
    {    143,10}, {    287, 9}, {    575,12}, {     95,11}, \
    {    191,10}, {    383, 9}, {    799,11}, {    207,13}, \
    {     63,12}, {    127,11}, {    255,10}, {    511, 9}, \
    {   1023,11}, {    271,10}, {    543,12}, {    159,11}, \
    {    319,10}, {    639, 9}, {   1279,11}, {    335,10}, \
    {    671,11}, {    351,10}, {    703,11}, {    367,12}, \
    {    191,10}, {    767,11}, {    399,10}, {    799,11}, \
    ...
    {    767,10}, {   1535,12}, {    415,11}, {    831,12}, \
    {    447,14}, {    127,13}, {    255,12}, {    511,11}, \
    {   1023,12}, {    543,11}, {   1087,12}, {    607,13}, \
    {    319,12}, {    639,11}, {   1279,12}, {    671,11}, \
    {   1343,12}, {    735,13}, {    383,12}, {    799,11}, \
    {   1599,12}, {    831,13}, {    447,12}, {    959,14}, \
    ...
    {   1023,14}, {   2303,15}, {  32768,16}, {  65536,17}, \
    { 131072,18}, { 262144,19}, { 524288,20}, {1048576,21}, \
    {2097152,22}, {4194304,23}, {8388608,24} }
#define SQR_FFT_TABLE3_SIZE 175
#define SQR_FFT_THRESHOLD                 5952
