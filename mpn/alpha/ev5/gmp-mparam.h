...
#define TOOM3_SQR_THRESHOLD          172

#define SB_PREINV_THRESHOLD            0  /* (preinv always) */
#define DC_THRESHOLD                  50
...
#define FFT_MUL_TABLE  { 528, 1184, 3136, 5376, 15360, 36864, 0 }
#define FFT_MODF_MUL_THRESHOLD       688
#define FFT_MUL_THRESHOLD           6784

#define FFT_SQR_TABLE  { 560, 1184, 3008, 5376, 7168, 36864, 0 }
#define FFT_MODF_SQR_THRESHOLD       752
#define FFT_SQR_THRESHOLD           7680
