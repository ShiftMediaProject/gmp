C SPARC v8 __mpn_addmul_1 -- Multiply a limb vector with a limb and
C add the result to a second limb vector.

C Copyright (C) 1992, 1993, 1994, 1995 Free Software Foundation, Inc.
