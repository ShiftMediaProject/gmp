C SuperSPARC __udiv_qrnnd division support, used from longlong.h.
C This is for SuperSPARC only, to compensate for its semi-functional
C udiv instruction.

C Copyright (C) 1993, 1994, 1996, 2000 Free Software Foundation, Inc.
