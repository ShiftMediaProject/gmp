dnl  This is a copy of mpn/x86/k6/sqr_basecase.asm, put here because on K7
dnl  it's faster than mpn/generic/sqr_basecase.c.  Something K7 specific
dnl  will probably replace this in the future.
