...
#define MUL_FFT_TABLE3                                      \
  { {    904, 6}, {     25, 7}, {     13, 6}, {     27, 7}, \
    ...
    {    143, 9}, {     79, 8}, {    159,10}, {     47, 9}, \
    {     95, 8}, {    191, 9}, {    103,11}, {     31,10}, \
    ...
    {   1279,10}, {    335, 9}, {    671,11}, {    191,10}, \
    {    383, 9}, {    831,11}, {    223,12}, {    127,11}, \
    ...
    {   1023,11}, {    543,10}, {   1087, 9}, {   2175,10}, \
    {   1119,11}, {    575,10}, {   1151,11}, {    607,10}, \
    {   1215, 9}, {   2431,12}, {    319,11}, {    639,10}, \
    {   1279,11}, {    671,10}, {   1407,11}, {    735,10}, \
    {   1471, 9}, {   2943,12}, {    383,11}, {    767,10}, \
    {   1535,11}, {    799,10}, {   1599,11}, {    831,10}, \
    {   1663,11}, {    863,10}, {   1727,11}, {    895,10}, \
    {   1791,11}, {    959,10}, {   1919,13}, {    255,12}, \
    {    511,11}, {   1023,10}, {   2047,11}, {   1087,10}, \
    {   2175,12}, {    575,11}, {   1151,10}, {   2303,11}, \
    {   1215,10}, {   2431,12}, {    639,11}, {   1407,10}, \
    {   2815,11}, {   1471,10}, {   2943,13}, {    383,12}, \
    {    767,11}, {   1599,12}, {    831,11}, {   1663,12}, \
    {    895,11}, {   1791,12}, {    959,11}, {   1919,10}, \
    {   3839,14}, {    255,13}, {    511,12}, {   1023,11}, \
    {   2047,12}, {   1087,11}, {   2239,12}, {   1151,11}, \
    {   2303,12}, {   1215,11}, {   2431,13}, {    639,12}, \
    {   1407,11}, {   2815,12}, {   1471,11}, {   2943,10}, \
    {   5887,13}, {    767,12}, {   1663,11}, {   3327,13}, \
    {    895,12}, {   1791,11}, {   3583,12}, {   1919,11}, \
    {   3839,12}, {   1983,11}, {   3967,14}, {    511,13}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    888, 6}, {     25, 7}, {     13, 6}, {     27, 7}, \
    ...
    {    159,10}, {    319, 9}, {    639, 8}, {   1279, 9}, \
    {    671, 8}, {   1343,11}, {    191,10}, {    383, 9}, \
    {    799, 8}, {   1599, 9}, {    831,12}, {    127,11}, \
    {    255,10}, {    543, 9}, {   1087,11}, {    287,10}, \
    {    575, 9}, {   1215, 8}, {   2431,11}, {    319,10}, \
    {    639, 9}, {   1407,12}, {    191,10}, {    799, 9}, \
    {   1599,10}, {    863,11}, {    447,13}, {    127,12}, \
    {    255,11}, {    511,10}, {   1023,11}, {    543,10}, \
    {   1087, 9}, {   2175,10}, {   1119,11}, {    575,10}, \
    {   1151,11}, {    607,10}, {   1215, 9}, {   2431,11}, \
    {    639,10}, {   1279,11}, {    671,10}, {   1407,11}, \
    {    735,10}, {   1471, 9}, {   2943,11}, {    767,10}, \
    {   1535,11}, {    799,10}, {   1599,11}, {    831,10}, \
    {   1727,11}, {    895,10}, {   1791,11}, {    959,10}, \
    {   1919,11}, {    991,13}, {    255,12}, {    511,11}, \
    {   1023,10}, {   2047,11}, {   1087,10}, {   2175,12}, \
    {    575,11}, {   1151,10}, {   2303,11}, {   1215,10}, \
    {   2431,12}, {    639,11}, {   1343,10}, {   2687,11}, \
    {   1407,10}, {   2815,11}, {   1471,10}, {   2943,12}, \
    {    767,11}, {   1599,12}, {    831,11}, {   1663,12}, \
    {    895,11}, {   1791,12}, {    959,11}, {   1919,10}, \
    {   3839,11}, {   1983,14}, {    255,13}, {    511,12}, \
    {   1023,11}, {   2047,12}, {   1087,11}, {   2175,12}, \
    {   1151,11}, {   2303,12}, {   1215,11}, {   2431,13}, \
    {    639,12}, {   1279,11}, {   2559,12}, {   1407,11}, \
    ...
    {   2239,13}, {   1151,12}, {   4096,13}, {   8192,14}, \
    {  16384,15}, {  32768,16} }
#define SQR_FFT_TABLE3_SIZE 194
...
#define POWM_SEC_TABLE  1,16,111,289,1133,1603
