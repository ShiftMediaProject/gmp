...
.Lun1:	pmuludq	%mm7, %mm6		C				un=1
	movd	%mm6, (%edx)		C				un=1
	psrlq	$32, %mm6		C				un=1
	movd	%mm6, 4(%edx)		C				un=1
	jmp	.Lret			C				un=1

.Lun2:	pmuludq	%mm7, %mm6		C				un=2
