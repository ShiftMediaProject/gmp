...
#define MUL_FFT_TABLE3                                      \
  { {   1125, 6}, {     19, 5}, {     39, 6}, {     27, 7}, \
    ...
    {    127,10}, {    287,11}, {    159,10}, {    335, 9}, \
    {    671,11}, {    191,10}, {    383, 9}, {    767,12}, \
    {    127,11}, {    287,10}, {    575, 9}, {   1151,10}, \
    {    607,11}, {    319,10}, {    639,12}, {    191,11}, \
    {    383,10}, {    799,13}, {    127,12}, {    255,11}, \
    {    511,10}, {   1055, 9}, {   2111,10}, {   1119, 9}, \
    {   2239,11}, {    607,12}, {    319,11}, {    671,10}, \
    {   1407,11}, {    735,10}, {   1471,12}, {    383,11}, \
    {    799,10}, {   1599,11}, {    863,10}, {   1727, 9}, \
    {   3455,12}, {    447,13}, {    255,12}, {    511,11}, \
    {   1055,10}, {   2111,11}, {   1119,10}, {   2239,12}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    888, 5}, {     28, 6}, {     15, 5}, {     32, 6}, \
    ...
    {    159,10}, {    319,11}, {    191,10}, {    383, 9}, \
    {    767,11}, {    223,12}, {    127,11}, {    255,10}, \
    {    511,11}, {    287,10}, {    607, 9}, {   1215,11}, \
    {    319,12}, {    191,11}, {    383,10}, {    799,13}, \
    {    127,12}, {    255,11}, {    511,10}, {   1055,11}, \
    {    543,10}, {   1119, 9}, {   2239,11}, {    575,10}, \
    {   1151,11}, {    607,12}, {    319,11}, {    671,10}, \
    {   1407,11}, {    735,10}, {   1471, 9}, {   2943,12}, \
    {    383,11}, {    799,10}, {   1599,11}, {    863,10}, \
    {   1727,12}, {    447,11}, {    959,13}, {    255,12}, \
    {    511,11}, {   1055,10}, {   2111,11}, {   1119,10}, \
    {   2239,12}, {    575,11}, {   1247,10}, {   2495,12}, \
    {    639,11}, {   1471,10}, {   2943,13}, {    383,12}, \
    {    767,11}, {   1599,12}, {    831,11}, {   1727,10}, \
    {   3455,12}, {    959,14}, {    255,13}, {    511,12}, \
    {   1023,11}, {   2111,12}, {   1087,11}, {   2239,10}, \
    {   4479,12}, {   1215,11}, {   2495,13}, {    639,12}, \
    {   1471,11}, {   2943,10}, {   5887,13}, {    767,12}, \
    {   1727,11}, {   3455,13}, {    895,12}, {   1791,11}, \
    {   3711,12}, {   1983,11}, {   3967,10}, {   7935,14}, \
    {    511,13}, {   1023,12}, {   2239,11}, {   4479,13}, \
    {   1151,12}, {   4096,13}, {   8192,14}, {  16384,15}, \
    {  32768,16} }
