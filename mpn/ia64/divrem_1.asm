...
C merge the loops for normalized and unnormalized divisor, size the shifting
C stuff is done in parallel with other operations.  It would even be possible
C to merge all four loops, if the ld8 were made conditional.
