...
all (void)
{
  ...
  {
    static const char *names[MAX_TABLE] = {
  ...
  {
    static const char *names[] = { "BZ_THRESHOLD" };
    one (speed_mpn_bz_tdiv_qr, bz_threshold, 1, NULL, names, NULL);
  }
  printf("\n");

  {
    static const char *names[] = { "FIB_THRESHOLD" };
    one (speed_mpz_fib_ui, fib_threshold, 1, NULL, names, NULL);
  }
  printf("\n");
  ...
  {
    static const char *names[] = { "POWM_THRESHOLD" };
    static struct param_t  param;
    param.stop_since_change = 10;
    one (speed_mpz_powm, powm_threshold, 1, NULL, names, &param);
  }
  printf("\n");

  {
    static const char *names[] = { "GCD_ACCEL_THRESHOLD" };
    one (speed_mpn_gcd, gcd_accel_threshold, 1, NULL, names, NULL);
  }
  {
    static const char *names[] = { "GCDEXT_THRESHOLD" };
    one (speed_mpn_gcdext, gcdext_threshold, 1, NULL, names, NULL);
  }
  printf("\n");
}
