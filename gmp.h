...
{ 
  GMP_GET_VERSION,
  GMP_GET_VERSION_MAJOR = GMP_GET_VERSION,
  GMP_GET_VERSION_MINOR,
  GMP_GET_VERSION_PATCHLEVEL
} gmp_version_enum;

#define __GNU_MP_VERSION gmp_version (GMP_GET_VERSION_MAJOR)
#define __GNU_MP_VERSION_MAJOR __GNU_MP_VERSION
#define __GNU_MP_VERSION_MINOR gmp_version (GMP_GET_VERSION_MINOR)
#define __GNU_MP_VERSION_PATCHLEVEL gmp_version (GMP_GET_VERSION_PATCHLEVEL)
